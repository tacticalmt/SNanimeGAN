...
for epoch in range(tr_epoch):
    ...
    if (epoch + 1) % 200 == 0:
        torch.save(generator.state_dict(), './models/' + str(epoch + 1)+'epoch' + version_p + 'SNGANanime256.pkl')
        torch.save(discriminator.state_dict(), './models/' + str(epoch + 1)+'epoch' + version_p + 'SNGANanime256.pkl')
